      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::text('date', ((isset($prescription->date))? $prescription->date : date('Y-m-d H:i:s') ), ['class' => 'form-control datetimepicker-input '. (($errors->has("date"))? "is-invalid" : ""), 'id' => 'date_picker', 'data-toggle' => 'datetimepicker', 'data-target' => '#date_picker', 'placeholder' => 'date', 'autocomplete' => 'off', 'required']) !!}
